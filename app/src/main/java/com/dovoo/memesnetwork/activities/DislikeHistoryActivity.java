...
public class DislikeHistoryActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dislike_history);
        ...
        videoRecyclerViewAdapter = new VideoRecyclerViewAdapter(mVideoPlayerManager, DislikeHistoryActivity.this, loadingBar, mList);
